...
cleaned_postcode_to_LSOA<- read_csv("Clean-data/Cleaned Postcode To LSOA Code.csv")

#Cleaning and joining data through the use of pipe operator
broadband_speed<-read_csv("Obtained-data/broadband-data/201805_fixed_pc_performance_r03.csv") %>% #Importing broadband speed csv into R
...
file_path <- "Clean-data/Cleaned Broadband Speed Dataset.csv"
