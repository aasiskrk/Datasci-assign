...
Grouped_school_dataset %>% 
  ...
  labs(title="2021 Average Attainment Score By County Box") #setting label for the chart


#-------------------20-21 avg attainment score in kent line chart------------------
...
Grouped_school_dataset2 %>%
  ...
  labs(title = "2020-2023 Average Attainment Score Line Graph For Kent's District", #defining labels 
       x = "Year",
